...
{
    public sealed class EditTestItemStructCommand : ICommand
    {
        public TestItem Value { get; }

        public EditTestItemStructCommand(TestItem value)
        {
            Value = value ?? throw new ArgumentNullException(nameof(value));
        }
    }

    public sealed class EditTestItemStructCommandHandler : ISqlCommandHandler<EditTestItemStructCommand>
    {
...
;";
        ...
        public async Task<ApiResponse<Unit>> Execute(SqlHattemSession connection, EditTestItemStructCommand command)
        {
